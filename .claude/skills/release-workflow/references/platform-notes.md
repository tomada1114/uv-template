...
- Dynamic context injection is replaced by explicit command execution, so the workflow spends a few extra steps collecting state but preserves the same release checks.
